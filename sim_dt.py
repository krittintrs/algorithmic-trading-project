...
import pandas as pd
import time
from agent_dt import DecisionTreeAgent
import warnings
...
agents = [DecisionTreeAgent, DecisionTreeAgent, DecisionTreeAgent, DecisionTreeAgent]
...
agent_1m = DecisionTreeAgent()
agent_1h = DecisionTreeAgent()
agent_4h = DecisionTreeAgent()
agent_1d = DecisionTreeAgent()
