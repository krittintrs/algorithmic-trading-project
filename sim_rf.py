...
import pandas as pd
import time
from agent_rf import RandomForestAgent
import warnings
...
agents = [RandomForestAgent, RandomForestAgent, RandomForestAgent, RandomForestAgent]
...
agent_1m = RandomForestAgent()
agent_1h = RandomForestAgent()
agent_4h = RandomForestAgent()
agent_1d = RandomForestAgent()
agent_1m.train_model(df_1m)
agent_1h.train_model(df_1h)
agent_4h.train_model(df_4h)
agent_1d.train_model(df_1d)
